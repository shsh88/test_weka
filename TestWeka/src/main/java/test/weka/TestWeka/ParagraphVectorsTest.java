...
*/
    ...
    public void testParagraphVectorsVocabBuilding1() throws Exception {
        //ClassPathResource resource = new ClassPathResource("/big/raw_sentences.txt");
        //File file = resource.getFile();//.getParentFile();
        SentenceIterator iter = new BasicLineIterator(new File("resources/raw_sentences.txt")); //UimaSentenceIterator.createWithPath(file.getAbsolutePath());
    ...
    public void testParagraphVectorsModelling1() throws Exception {
        ...
        SentenceIterator iter = new BasicLineIterator(new File("resources/raw_sentences.txt"));
        ...
        List<String> labelsOriginal = vec.getLabelsSource().getLabels();
...
//        assertTrue(similarity2 > 0.7d);
        ...
        List<String> labelsRestored = vec3.getLabelsSource().getLabels();
        ...
        List<String> labelsBinary = vec2.getLabelsSource().getLabels();
    ...
    public void testParagraphVectorsDM() throws Exception {
    	//the next two line are commented out by Razan and the third is added by her
        //ClassPathResource resource = new ClassPathResource("/big/raw_sentences.txt");
        //File file = resource.getFile();
        SentenceIterator iter = new BasicLineIterator(new File("resources/raw_sentences.txt"));
...
//        assertTrue(similarity2 > 0.7d);
    ...
    public void testParagraphVectorsReducedLabels1() throws Exception {
        ...
        LabelAwareIterator iter = new FileLabelAwareIterator.Builder()
                .addSourceFolder(new File("/labeled"))
                .build();
    ...
    */
    ...
    public void testParagraphVectorsOverExistingWordVectorsModel() throws Exception {
        ...
        SentenceIterator iter = new AggregatingSentenceIterator.Builder()
                .addSentenceIterator(new BasicLineIterator(new File("resources/raw_sentences.txt")))
                .addSentenceIterator(new FileSentenceIterator(new File("/paravec")))
                .build();
        ...
        FileLabelAwareIterator labelAwareIterator = new FileLabelAwareIterator.Builder()
                .addSourceFolder(new File("/paravec/labeled"))
                .build();
        ...
        FileLabelAwareIterator unlabeledIterator = new FileLabelAwareIterator.Builder()
                .addSourceFolder(new File("/paravec/unlabeled"))
                .build();
