	...
	public static void main(String[] args){
		...
		try {
			openNlp.useOpenNlp("My name is Rushdi Shams. "
					...
					+ "but I am a bit shy to use it.", "resources/opennlp-models/en-sent.bin", "sentence");
			openNlp.useOpenNlp("\"Let's get this vis-a-vis\", he said, \"these boys' marks are really that well?\"", "resources/opennlp-models/en-token.bin", "word");
		} catch (IOException e) {
		}
	}
